...
const TestimonialData = [
  {
    ...
    text: "The interior design team truly transformed my space! They captured my style perfectly, creating a functional and beautiful home. I couldn’t be happier with the results.",
    delay: 0.2,
  },
  {
    id: 2,
    ...
    text: "Amazing service! They listened to my ideas and brought them to life in a way that exceeded my expectations. My home feels stylish and cozy.",
    delay: 0.4,
  },
  {
    id: 3,
    ...
    text: "Professional, creative, and detail-oriented. They turned my vision into reality, and I love every corner of my redesigned home!",
    delay: 0.6,
  },
];
const Testimonial = () => {
