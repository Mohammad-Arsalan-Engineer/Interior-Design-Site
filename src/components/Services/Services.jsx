...
const ServiceCard = [
  {
    ...
    description:
      "Indulge in unparalleled comfort with our exclusive facilities, designed for the ultimate in relaxation and sophistication.",
    icon: <FaVectorSquare />,
    link: "#",
    delay: 0.2,
  },
  {
    ...
    description:
      "Experience excellence with our high-quality products, crafted to meet the highest standards of durability and performance.",
    icon: <FaPenToSquare />,
    link: "#",
    delay: 0.4,
  },
  {
    ...
    description:
      "Get the best value for your money with our competitively priced options, offering premium quality at budget-friendly rates.",
